...
public abstract class SQLDataSourceEditorProvider implements FileEditorProvider, DumbAware {

    protected abstract String getTypeName();
    protected abstract Class<? extends SqlDataSourceEditor> getEditorClass();
