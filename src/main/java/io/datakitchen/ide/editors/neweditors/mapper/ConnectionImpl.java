...
public class ConnectionImpl implements Connection {
    ...
    private final DataMapperConnectionList connectionList;
    ...
    private final DataMapperModel model;
    private String name;


    public ConnectionImpl(DataMapperModel model, DataMapperConnectionList connectionList, Connector connector){
        this.model = model;
    ...
    public ConnectionImpl(DataMapperModel model, DataMapperConnectionList connectionList, String name, Connector connector){
        this.model = model;
        this.connectionList = connectionList;
        this.name = name;
        this.connector = connector;
        ...
        if (tests.add(test)){
            ...
            if (test.getVariable().getVariableName() == null){
                if (test instanceof FileTest){
                    ...
                    if (variable == null){
                        test.getVariable().setVariableName(makeVariableNameForTest(test, test.getVariable().getAttribute()));
    ...
    public void removeKey(Key key) {
        if (keys.contains(key)) {
            ...
            ((DataMapperModelImpl)connectionList.getModel()).notifySourceKeyRemoved(key);
        }
    }
