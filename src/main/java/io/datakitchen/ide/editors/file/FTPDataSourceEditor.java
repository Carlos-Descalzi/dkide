...
public class FTPDataSourceEditor extends FileDataSourceEditor{

    private FTPConfigEditor configEditor;
    public FTPDataSourceEditor(Project project, VirtualFile file) {
        super(project, file);
    }
    ...
    protected JComponent buildConfigurationPanel() {
        ...
        configEditor = new FTPConfigEditor(module);
        return configEditor;
    }
