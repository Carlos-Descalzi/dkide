...
public class GCSDataSourceEditor extends FileDataSourceEditor{

    private GCSConfigEditor configEditor;
    public GCSDataSourceEditor(Project project, VirtualFile file) {
        super(project, file);
    }
    ...
    protected JComponent buildConfigurationPanel() {
        ...
        configEditor = new GCSConfigEditor(module);
        return configEditor;
    }
