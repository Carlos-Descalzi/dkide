...
public interface JSONListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link JSONParser#varRef}.
	 * @param ctx the parse tree
	 */
	void enterVarRef(JSONParser.VarRefContext ctx);
	/**
	 * Exit a parse tree produced by {@link JSONParser#varRef}.
	 * @param ctx the parse tree
	 */
	void exitVarRef(JSONParser.VarRefContext ctx);
	/**
